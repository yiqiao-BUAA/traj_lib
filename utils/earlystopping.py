...
class EarlyStopping(object):
    ...
    def __init__(
        ...
        if is_pretrain:
            self.save_model_path = os.path.join(
                save_model_folder, f"{save_model_name}_pretrain.pkl"
            )
        else:
            self.save_model_path = os.path.join(
    ...
    def step(self, metrics: list, model: nn.Module) -> bool:
        """
    ...
    def load_checkpoint(self, model: nn.Module, map_location: Optional[str] = None) -> None:
        """
